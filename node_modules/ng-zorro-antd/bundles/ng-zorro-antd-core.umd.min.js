...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://github.com/NG-ZORRO/ng-zorro-antd/blob/master/LICENSE
     */var lt=function(){function e(){this.UNIQUE_WRAPPERS=["##==-open_tag-==##","##==-close_tag-==##"]}return e.prototype.transform=function(e,t,n,r){if(!t)return e;var i=new RegExp(t.replace(/([.*+?^=!:${}()|[\]\/\\])/g,"\\$&"),n);return function(e){return e.replace(/&/g,"&amp;").replace(ct,function(e){return"&#"+(1024*(e.charCodeAt(0)-55296)+(e.charCodeAt(1)-56320)+65536)+";"}).replace(dt,function(e){return"&#"+e.charCodeAt(0)+";"}).replace(/</g,"&lt;").replace(/>/g,"&gt;")}(e.replace(i,this.UNIQUE_WRAPPERS[0]+"$&"+this.UNIQUE_WRAPPERS[1])).replace(new RegExp(this.UNIQUE_WRAPPERS[0],"g"),r?'<span class="'+r+'">':"<span>").replace(new RegExp(this.UNIQUE_WRAPPERS[1],"g"),"</span>")},e.decorators=[{type:n.Pipe,args:[{name:"nzHighlight",pure:!0}]}],e}();var ut=function(){function e(){}return e.decorators=[{type:n.NgModule,args:[{imports:[t.CommonModule],exports:[lt],declarations:[lt]}]}],e}();var pt=new n.InjectionToken("nz-config"),ft=function(e){return void 0!==e},ht=function(){function e(e){this.configUpdated$=new p.Subject,this.config=e||{}}return e.prototype.getConfigForComponent=function(e){return this.config[e]},e.prototype.getConfigChangeEventForComponent=function(e){return this.configUpdated$.pipe(f.filter(function(t){return t===e}),f.mapTo(void 0))},e.prototype.set=function(e,t){this.config[e]=g({},this.config[e],t),this.configUpdated$.next(e)},e.decorators=[{type:n.Injectable,args:[{providedIn:"root"}]}],e.ctorParameters=function(){return[{type:void 0,decorators:[{type:n.Optional},{type:n.Inject,args:[pt]}]}]},e.ngInjectableDef=n.ɵɵdefineInjectable({factory:function(){return new e(n.ɵɵinject(pt,8))},token:e,providedIn:"root"}),e}();var yt=function(e){return e.charAt(0).toLowerCase()+e.slice(1)},gt=function(e){return yt(e.replace("Nz","").replace(/(Component|Directive|Service|ContainerComponent)$/g,"").toLowerCase())};var vt=function(){function e(){}return e.prototype.transform=function(e,t){void 0===t&&(t="px");var n=+e;return isNaN(n)?""+e:""+n+t},e.decorators=[{type:n.Pipe,args:[{name:"nzToCssUnit"}]}],e}(),mt=function(){function e(){}return e.prototype.transform=function(e,t){void 0===t&&(t="HH:mm:ss");var n=Number(e||0);return se.reduce(function(e,t){var r=b(t,2),i=r[0],o=r[1];if(-1!==e.indexOf(i)){var a=Math.floor(n/o);return n-=a*o,e.replace(new RegExp(i+"+","g"),function(e){return Le(a.toString(),e.length,"0")})}return e},t)},e.decorators=[{type:n.Pipe,args:[{name:"nzTimeRange",pure:!0}]}],e}(),bt=function(){function e(){}return e.decorators=[{type:n.NgModule,args:[{imports:[t.CommonModule],exports:[mt,vt],declarations:[mt,vt]}]}],e}();e.AnimationCurves=k,e.AnimationDuration=S,e.CandyDate=ae,e.DEFAULT_DROPDOWN_POSITIONS=ne,e.DEFAULT_MENTION_BOTTOM_POSITIONS=oe,e.DEFAULT_MENTION_TOP_POSITIONS=ie,e.DEFAULT_SUBMENU_POSITIONS=re,e.DEFAULT_TOOLTIP_POSITIONS=te,e.FakeViewportRuler=ke,e.InputBoolean=K,e.InputCssPixel=function(){return q("InputCssPixel",$)},e.InputNumber=function(){return q("InputNumber",W)},e.MockNgZone=Oe,e.NZ_CONFIG=pt,e.NZ_WAVE_GLOBAL_CONFIG=et,e.NZ_WAVE_GLOBAL_CONFIG_FACTORY=tt,e.NZ_WAVE_GLOBAL_DEFAULT_CONFIG=Je,e.NzAddOnModule=w,e.NzBreakpoint={xxl:"xxl",xl:"xl",lg:"lg",md:"md",sm:"sm",xs:"xs"},e.NzClassListAddDirective=C,e.NzConfigService=ht,e.NzConnectedOverlayDirective=Q,e.NzCopyToClipboardService=ye,e.NzCopyToClipboardServiceModule=he,e.NzDomEventService=ge,e.NzDropdownHigherOrderServiceToken=ot,e.NzHighlightModule=ut,e.NzHighlightPipe=lt,e.NzMenuBaseService=it,e.NzNoAnimationDirective=G,e.NzNoAnimationModule=Z,e.NzOverlayModule=J,e.NzPipesModule=bt,e.NzScrollService=le,e.NzSingletonService=me,e.NzStringTemplateOutletDirective=E,e.NzTimeRangePipe=mt,e.NzToCssUnitPipe=vt,e.NzTransButtonDirective=at,e.NzTransButtonModule=st,e.NzTreeBase=Ze,e.NzTreeBaseService=Ke,e.NzTreeHigherOrderServiceToken=Ge,e.NzTreeNode=Te,e.NzUpdateHostClassService=fe,e.NzWaveDirective=nt,e.NzWaveModule=rt,e.NzWaveRenderer=Qe,e.POSITION_MAP=ee,e.PREFIX=B,e.SCROLL_SERVICE_PROVIDER=pe,e.SCROLL_SERVICE_PROVIDER_FACTORY=ue,e.WithConfig=function(e){return function(t,n,r){var i="$$__assignedValue__"+n,o=gt(t.constructor.name);return Object.prototype.hasOwnProperty.call(t,i)&&console.warn('The prop "'+i+'" is already exist, it will be override by '+o+" decorator."),Object.defineProperty(t,i,{configurable:!0,writable:!0,enumerable:!1}),{get:function(){var t=r&&r.get?r.get.bind(this)():this[i];if(ft(t))return t;var a=(this.nzConfigService.getConfigForComponent(o)||{})[n];return ft(a)?a:e},set:function(e){r&&r.set?r.set.bind(this)(e):this[i]=e},configurable:!0,enumerable:!0}}},e.arraysEqual=function(e,t){if(!e||!t||e.length!==t.length)return!1;for(var n=e.length,r=0;r<n;r++)if(e[r]!==t[r])return!1;return!0},e.cancelRequestAnimationFrame=function(e){if("undefined"==typeof window)return null;if(window.cancelAnimationFrame)return window.cancelAnimationFrame(e);var t=ce.filter(function(e){return e+"CancelAnimationFrame"in window||e+"CancelRequestAnimationFrame"in window})[0];return t?(window[t+"CancelAnimationFrame"]||window[t+"CancelRequestAnimationFrame"]).call(this,e):clearTimeout(e)},e.collapseMotion=O,e.createDebugEle=Me,e.createFakeEvent=Ee,e.createKeyboardEvent=Ce,e.createMouseEvent=be,e.createTouchEvent=Ne,e.dispatchEvent=we,e.dispatchFakeEvent=Se,e.dispatchKeyboardEvent=function(e,t,n,r){return we(e,Ce(t,n,r))},e.dispatchMouseEvent=function(e,t,n,r,i){return void 0===n&&(n=0),void 0===r&&(r=0),void 0===i&&(i=be(t,n,r)),we(e,i)},e.dispatchTouchEvent=function(e,t,n,r){return void 0===n&&(n=0),void 0===r&&(r=0),we(e,Ne(t,n,r))},e.ensureInBounds=
/**
     * @license
     * Copyright Alibaba.com All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://github.com/NG-ZORRO/ng-zorro-antd/blob/master/LICENSE
     */
function(e,t){return e&&e<t?e:t},e.ensureNumberInRange=function(e,t,n){return isNaN(e)||e<t?t:e>n?n:e}
/**
     * @license
     * Copyright Alibaba.com All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://github.com/NG-ZORRO/ng-zorro-antd/blob/master/LICENSE
     */,e.fadeMotion=x,e.filterNotEmptyNode=_e,e.findFirstNotEmptyNode=function(e){for(var t=e.childNodes,n=0;n<t.length;n++){var r=t.item(n);if(_e(r))return r}return null},e.findLastNotEmptyNode=function(e){for(var t=e.childNodes,n=t.length-1;n>=0;n--){var r=t.item(n);if(_e(r))return r}return null},e.getCaretCoordinates=function(e,t,n){if(!De)throw new Error("textarea-caret-position#getCaretCoordinates should only be called in a browser");var r=n&&n.debug||!1;if(r){var i=document.querySelector("#input-textarea-caret-position-mirror-div");i&&i.parentNode.removeChild(i)}var o=document.createElement("div");o.id="input-textarea-caret-position-mirror-div",document.body.appendChild(o);var a=o.style,s=window.getComputedStyle?window.getComputedStyle(e):e.currentStyle,c="INPUT"===e.nodeName;a.whiteSpace="pre-wrap",c||(a.wordWrap="break-word"),a.position="absolute",r||(a.visibility="hidden"),Ie.forEach(function(e){c&&"lineHeight"===e?a.lineHeight=s.height:a[e]=s[e]}),Re?e.scrollHeight>ze(s.height)&&(a.overflowY="scroll"):a.overflow="hidden",o.textContent=e.value.substring(0,t),c&&(o.textContent=o.textContent.replace(/\s/g," "));var d=document.createElement("span");d.textContent=e.value.substring(t)||".",o.appendChild(d);var l={top:d.offsetTop+ze(s.borderTopWidth),left:d.offsetLeft+ze(s.borderLeftWidth),height:ze(s.lineHeight)};return r?(d.style.backgroundColor="#eee",Me(e,l)):document.body.removeChild(o),l},e.getElementOffset=function(e){if(!e.getClientRects().length)return{top:0,left:0};var t=e.getBoundingClientRect(),n=e.ownerDocument.defaultView;return{top:t.top+n.pageYOffset,left:t.left+n.pageXOffset}},e.getMentions=function(e,t){if(void 0===t&&(t="@"),"string"!=typeof e)return[];var n=Ae(t),r=e.match(n);return null!==r?r.map(function(e){return e.trim()}):[]},e.getPercent=
/**
     * @license
     * Copyright Alibaba.com All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://github.com/NG-ZORRO/ng-zorro-antd/blob/master/LICENSE
     */
function(e,t,n){return(n-e)/(t-e)*100},e.getPlacementName=function(e){var t=["originX","originY","overlayX","overlayY"],n=function(n){if(t.every(function(t){return e.connectionPair[t]===ee[n][t]}))return{value:n}};for(var r in ee){var i=n(r);if("object"==typeof i)return i.value}},e.getPrecision=function(e){var t=e.toString(),n=t.indexOf(".");return n>=0?t.length-n-1:0},e.getRegExp=Ae,e.getRepeatedElement=Pe,e.getStyleAsText=function(e){return e?Object.keys(e).map(function(t){var n=e[t];return t+":"+("string"==typeof n?n:n+"px")}).join(";"):""}
/**
     * @license
     * Copyright Alibaba.com All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://github.com/NG-ZORRO/ng-zorro-antd/blob/master/LICENSE
     */,e.helpMotion=_,e.inNextTick=function(){var e=new p.Subject;return Promise.resolve().then(function(){return e.next()}),e.pipe(f.take(1))},e.isComponent=function(e){return e instanceof n.Type},e.isEmpty=function(e){for(var t=e.childNodes,n=0;n<t.length;n++)if(_e(t.item(n)))return!1;return!0},e.isInteger=function(e){return"number"==typeof e&&isFinite(e)&&Math.floor(e)===e},e.isNil=function(e){return null==e},e.isNonEmptyString=function(e){return"string"==typeof e&&""!==e},e.isNotNil=xe,e.isPromise=function(e){return!!e&&"function"==typeof e.then&&"function"==typeof e.catch},e.isStyleSupport=function(e){if("undefined"!=typeof window&&window.document&&window.document.documentElement){var t=Array.isArray(e)?e:[e],n=window.document.documentElement;return t.some(function(e){return e in n.style})}return!1},e.isTemplateRef=function(e){return e instanceof n.TemplateRef},e.isTouchEvent=function(e){return e.type.startsWith("touch")},e.log=function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];n.isDevMode()&&console.log.apply(console,N([B],e))},e.measure=function(e,t,n,r,i){je||((je=document.createElement("div")).setAttribute("aria-hidden","true"),document.body.appendChild(je));var o,a=window.getComputedStyle(e),s=(o=a,Array.prototype.slice.apply(o).map(function(e){return e+": "+o.getPropertyValue(e)+";"}).join("")),c=Xe(a.lineHeight)*(t+1)+Xe(a.paddingTop)+Xe(a.paddingBottom);je.setAttribute("style",s),je.style.position="fixed",je.style.left="0",je.style.height="auto",je.style.minHeight="auto",je.style.maxHeight="auto",je.style.top="-999999px",je.style.zIndex="-1000",je.style.textOverflow="clip",je.style.whiteSpace="normal",je.style.webkitLineClamp="none";var d,l=(d=[],n.forEach(function(e){var t=d[d.length-1];t&&e.nodeType===He&&t.nodeType===He?t.data+=e.data:d.push(e)}),d),u=document.createElement("div"),p=document.createElement("span"),f=document.createElement("span");function h(){return je.offsetHeight<c}if(Object.assign(u.style,Fe),Object.assign(p.style,Fe),Object.assign(f.style,Fe),l.forEach(function(e){p.appendChild(e)}),r.forEach(function(e){f.appendChild(e.cloneNode(!0))}),u.appendChild(p),u.appendChild(f),je.appendChild(u),h()){var y=je.innerHTML;return je.removeChild(u),{contentNodes:n,text:y,ellipsis:!1}}var g=Array.prototype.slice.apply(je.childNodes[0].childNodes[0].cloneNode(!0).childNodes).filter(function(e){return e.nodeType!==Ve}),v=Array.prototype.slice.apply(je.childNodes[0].childNodes[1].cloneNode(!0).childNodes);je.removeChild(u),je.innerHTML="";var m=document.createElement("span");je.appendChild(m);var b=document.createTextNode(i);function N(e,t){var n,r=e.nodeType;if(r===Be)return h()?{finished:!1,node:l[t]}:(m.removeChild(e),{finished:!0,node:null});if(r===He){var i=e.textContent||"",o=document.createTextNode(i);return n=o,m.insertBefore(n,b),function e(t,n,r,i,o){void 0===r&&(r=0),void 0===i&&(i=n.length),void 0===o&&(o=0);var a=Math.floor((r+i)/2),s=n.slice(0,a);if(t.textContent=s,r>=i-1)for(var c=i;c>=r;c-=1){var d=n.slice(0,c);if(t.textContent=d,h())return c===n.length?{finished:!1,node:document.createTextNode(n)}:{finished:!0,node:document.createTextNode(d)}}return h()?e(t,n,a,i,a):e(t,n,r,a,o)}(o,i)}return{finished:!1,node:null}}m.appendChild(b),v.forEach(function(e){je.appendChild(e)});var C=[];g.some(function(e,t){var n=N(e,t),r=n.finished,i=n.node;return i&&C.push(i),r});for(var E={contentNodes:C,text:je.innerHTML,ellipsis:!0};je.firstChild;)je.removeChild(je.firstChild);return E}
/**
     * @license
     * Copyright Alibaba.com All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://github.com/NG-ZORRO/ng-zorro-antd/blob/master/LICENSE
     * @type {?}
     */,e.measureScrollbar=function(e,t){if(void 0===e&&(e="vertical"),void 0===t&&(t="ant"),"undefined"==typeof document||"undefined"==typeof window)return 0;var n="vertical"===e;if(n&&Ye)return Ye;if(!n&&Ue)return Ue;var r=document.createElement("div");Object.keys(We).forEach(function(e){r.style[e]=We[e]}),r.className=t+"-hide-scrollbar scroll-div-append-to-body",n?r.style.overflowY="scroll":r.style.overflowX="scroll",document.body.appendChild(r);var i=0;return n?(i=r.offsetWidth-r.clientWidth,Ye=i):(i=r.offsetHeight-r.clientHeight,Ue=i),document.body.removeChild(r),i},e.moveUpMotion=A,e.notificationMotion=L,e.padEnd=function(e,t,n){return(""+e+Pe(t,n)).slice(0,t)},e.padStart=Le,e.properties=Ie,e.pxToNumber=Xe,e.reqAnimFrame=de,e.responsiveMap={xs:"(max-width: 575px)",sm:"(min-width: 576px)",md:"(min-width: 768px)",lg:"(min-width: 992px)",xl:"(min-width: 1200px)",xxl:"(min-width: 1600px)"},e.reverseChildNodes=function(e){var t=e.childNodes,n=t.length;if(n){var r=[];for(t.forEach(function(e,t){return r[t]=e});n--;)e.appendChild(r[n])}},e.scrollIntoView=function(e){var t=e;t.scrollIntoViewIfNeeded?t.scrollIntoViewIfNeeded(!1):e.scrollIntoView&&e.scrollIntoView(!1)},e.shallowCopyArray=function(e){return e.slice()},e.shallowEqual=function(e,t){if(e===t)return!0;if("object"!=typeof e||!e||"object"!=typeof t||!t)return!1;var n=Object.keys(e),r=Object.keys(t);if(n.length!==r.length)return!1;for(var i=Object.prototype.hasOwnProperty.bind(t),o=0;o<n.length;o++){var a=n[o];if(!i(a))return!1;if(e[a]!==t[a])return!1}return!0},e.silentEvent=function(e){e.stopPropagation(),e.preventDefault()},e.slideAlertMotion=R,e.slideMotion=D,e.sortRangeValue=function(e){if(Array.isArray(e)){var t=b(e,2),n=t[0],r=t[1];return n&&r&&n.isAfterSecond(r)?[r,n]:[n,r]}return e},e.timeUnits=se,e.toArray=
/**
     * @license
     * Copyright Alibaba.com All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://github.com/NG-ZORRO/ng-zorro-antd/blob/master/LICENSE
     */
function(e){return null==e?[]:Array.isArray(e)?e:[e]},e.toBoolean=X,e.toCssPixel=$,e.toNumber=W,e.treeCollapseMotion=T,e.trimComponentName=gt,e.typeInElement=function(e,t){t.focus(),t.value=e,Se(t,"input")}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,e.valueFunctionProp=function(e){for(var t=[],n=1;n<arguments.length;n++)t[n-1]=arguments[n];return"function"==typeof e?e.apply(void 0,N(t)):e},e.warn=V,e.warnDeprecation=F,e.wrappedErrorMessage=function(e){var t=e.message.replace(/[|\\{}()[\]^$+*?.]/g,"\\$&");return new RegExp(t)},e.zoomBadgeMotion=j,e.zoomBigMotion=M,e.zoomMotion=z,Object.defineProperty(e,"__esModule",{value:!0})});
