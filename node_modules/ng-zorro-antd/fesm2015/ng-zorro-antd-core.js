 ...
 */
// tslint:disable-next-line:typedef
function WithConfig(innerDefaultValue) {
    return (/**
     * @param {?} target
     * @param {?} propName
     * @param {?=} originalDescriptor
